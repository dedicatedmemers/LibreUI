...
public enum VersionBridgeProviders {;
     ...
     */
    private static final Map<String, VersionBridgeProvider> PROVIDERS =
     ...
     */
    public static void registerProvider(String name, VersionBridgeProvider provider)
        ...
        if (name.equals(DEFAULT_PROVIDER_NAME)) {
            throw new IllegalArgumentException(
                    "The default provider must explicitly be set" +
                            "using the setDefaultProvider method");
        }
     ...
     * provider registered
     */
    public static VersionBridge newInstance(Version version)
            throws UnsupportedVersionException, IllegalArgumentException {
     ...
     */
    public static VersionBridge newInstance(String name, Version version)
            throws UnsupportedVersionException, IllegalArgumentException {
        ...
        return provider.newVersionBridge(version);
    }
}
